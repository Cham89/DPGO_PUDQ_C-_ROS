...
public:
    ...
    void communicationCallback(const distributed_pgo::PgoUpdate::ConstPtr& msg) {
...

        {
            ...
            if (graph_updated) {
                ...
                current_grad_norm = riemannian_norm(m_local_graph, result.rgrad_X, offset);
    ...
    void saveFinalResults() {
        ...
        double final_grad = pudqlib::riemannian_norm(m_local_graph, result_opt.rgrad_X, offset);
