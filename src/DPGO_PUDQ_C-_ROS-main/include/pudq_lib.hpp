...
namespace pudqlib{
    ...
    double riemannian_dot(const LocalGraph& graph, const Eigen::VectorXd& u, const Eigen::VectorXd& v, int offset = 0);
    double riemannian_norm(const LocalGraph& graph, const Eigen::VectorXd& u, int offset = 0);
